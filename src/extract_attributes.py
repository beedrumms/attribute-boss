...
class Extract:
    ...
    def extract_address(self, addresses):
        ...
        ARGS
        addresses (list/array) == a list or array containing the strs with the addresses you want to extract
        ...
        try:
            ...
            search_pattern = list(map(lambda x: x if x == None else address_pattern.search(x), addresses))
            ...
            return cln_addy
                ...
                print("Missing required argument or incorrect data struct given for arg *addresses*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise

        except TypeError as e:

                print("Incorrect data given for arg *addresses*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise

    # %%

    def extract_postal_code(self, postal_code_list):
        ...
        try: 
            ...
            search_pattern = list(map(lambda x: x if x == None else code_pattern.search(x), postal_code_list))
            ...
            return pattern_matches
                ...
                print("Missing required argument or incorrect data struct given for arg *postal_code_list*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise

        except TypeError as e:

                print("Incorrect data given for arg *postal_code_list*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise


    # %%

    def extract_phone_number(self, phone_num_list):
        ...
        try:
            ...
            search_pattern = list(map(lambda x: x if x == None else num.search(x), phone_num_list))
            ...
            return pattern_matches
                ...
                print("Missing required argument or incorrect data struct given for arg *phone_num_list*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise

        except TypeError as e:

                print("Incorrect data given for arg *phone_num_list*", "\n", "see func.__doc__ for more information on use", "\n",  str(e))
                raise